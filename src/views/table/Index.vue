  ...
  <div class="table">
    <table border="1" cellspacing="0">
        <tbody>
            ...
            <tr>
                <td colspan="26" style="text-align: left;box-sizing: border-box;padding: 10px;font-size: 14px;">
                    备注: 
                     <p style="text-indent: 20px;margin: 0;">1、交接班必须面对面交接，交班值班员填写交接时的设备运行状态及实物状况；</p>
                     <p style="text-indent: 20px;margin: 0;">2、前一班交接事项由交班值班员填写当班期间的文档归档情况、异常情况、遗留工作、上一班未完事项的完成情况；</p>
